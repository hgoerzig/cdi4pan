...
1) Locate your odk yaml file and open it with your favourite text editor (src/ontology/cdi4pan-odk.yaml)
...
```
  <uri name="http://www.purl.org/cdi4pan/cdpn/components/your-component-name.owl" uri="components/your-component-name.owl"/>
```

4) Add the component to the edit file (src/ontology/cdi4pan-edit.obo)
for .obo formats: 

```
import: http://www.purl.org/cdi4pan/cdpn/components/your-component-name.owl
```
...
6) In your custom makefile (src/ontology/cdi4pan.Makefile) add a goal for your custom make file. In this example, the goal is a ROBOT template.
