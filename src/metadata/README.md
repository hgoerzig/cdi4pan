 ...
 * [cdi4pan.yml](cdi4pan.yml)
     * Determines how your purl.obolibrary.org/obo/cdi4pan/ redirects will be handled
     ...
     * Paste in the contents of [cdi4pan.yml](cdi4pan.yml)
 ...
 * [cdi4pan.md](cdi4pan.md)
     ...
     * Paste in the contents of [cdi4pan.md](cdi4pan.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
